...
- Release 页面：[v1.6.0](https://github.com/dcajusteno-ops/qijiu-demo/releases/tag/v1.6.0)
...
- **个人中心** — 维护昵称、简介、主页链接、每日目标、默认进入页与单张展示图，并在同一页面查看创作概览
...
| 版本 | 日期 | 说明 |
|------|------|------|
| v1.6.0 | 2026-04-15 | 新增简约风“个人中心”：支持资料编辑、默认进入页、单张展示图与创作摘要；继续优化“数据视界”节点详情与滚动布局，完善侧栏入口与界面细节 |
