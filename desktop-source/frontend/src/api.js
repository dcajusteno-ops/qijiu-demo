...
export const GetPromptLibraryEntries = async () => callApp('GetPromptLibraryEntries')
export const GetCustomPromptEntries = async () => callApp('GetCustomPromptEntries')
export const AddCustomPromptEntry = async (data) => callApp('AddCustomPromptEntry', data)
export const DeleteCustomPromptEntry = async (id) => callApp('DeleteCustomPromptEntry', id)
export const GetPromptAssistantState = async () => callApp('GetPromptAssistantState')
export const SavePromptAssistantState = async (state) => callApp('SavePromptAssistantState', state)
