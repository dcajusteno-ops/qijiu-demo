...
export const PinCustomRoot = async (id) => callApp('PinCustomRoot', id)
...
export const GetImagesIndex = async (sortBy, sortOrder) => callApp('GetImagesIndex', sortBy, sortOrder)
export const GetImagesPage = async (query) => callApp('GetImagesPage', query)
export const GetWorkbenchAggregate = async (query) => callApp('GetWorkbenchAggregate', query)
...
export const GetWindowBehaviorSettings = async () => callApp('GetWindowBehaviorSettings')
export const ToggleAlwaysOnTop = async (enabled) => callApp('ToggleAlwaysOnTop', enabled)
export const ShowCompactWindow = async () => callApp('ShowCompactWindow')
export const RestoreMainWindow = async () => callApp('RestoreMainWindow')
export const GetGalleryPerformanceSettings = async () => callApp('GetGalleryPerformanceSettings')
export const SaveGalleryPerformanceSettings = async (settings) => callApp('SaveGalleryPerformanceSettings', settings)
export const GetImageGallerySummary = async () => callApp('GetImageGallerySummary')
export const GetDirectoryHealthSummary = async () => callApp('GetDirectoryHealthSummary')
export const RunDirectoryHealthAction = async (action) => callApp('RunDirectoryHealthAction', action)
